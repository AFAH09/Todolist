      ...
      <div className="container">
        <div className="col-4 mx-auto">
          <div class="input-group mb-3">
            ...
            />
            <button class="btn btn-primary" type="button" onClick={handleAddTodo}>
          ...
          <div class="card">
            {todos.map((todo, index) => (
              <ul class="list-group list-group-flush d-flex" key={index}>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"  stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-circle-check" >
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
